<aside class="sidebar sidebar-base sidebar-white sidebar-white navs-rounded-all " id="first-tour"
    ...
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="/nurse/dashboard" class="navbar-brand">
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('nurse/dashboard') ? 'active' : '' }}" aria-current="page"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('nurse/nurse-timetable') ? 'active' : '' }}" aria-current="page"
                        href="/nurse/nurse-timetable">
                ...
                <li class="nav-item">
                    <a class="nav-link " aria-current="page" href="/nurse/logout">
