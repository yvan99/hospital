<aside class="sidebar sidebar-base sidebar-white sidebar-white navs-rounded-all " id="first-tour"
    ...
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="/receptionist/dashboard" class="navbar-brand">
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('receptionist/patients') ? 'active' : '' }}" aria-current="page"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('receptionist/nurses') ? 'active' : '' }}" aria-current="page"
                        href="/receptionist/nurses">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('receptionist/nurse-timetable') ? 'active' : '' }}" aria-current="page"
                        href="/receptionist/nurse-timetable">
                        <i class="icon" data-bs-toggle="tooltip" title="UI Elements" data-bs-placement="right">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                        ...
                        <span class="item-name">Nurses Timetable</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link " aria-current="page" href="/receptionist/logout">
